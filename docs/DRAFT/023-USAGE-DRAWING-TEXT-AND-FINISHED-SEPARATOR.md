...
|                      |                                                                                                                                                                                                                                                                                    |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Status**           | CLOSED 2026-09-23. F1 dan F2 selesai; commit lokal `c79dac2` (kode `app-ui`, test, README, amandemen §6.5, tiga baris log alasan `DESIGN.md` §11, baris register draft 007, dan draft 023 ini) plus satu commit catatan status sesudahnya, keduanya belum di-push |
