...
|                      |                                                                                                                                                                                                                                                                                    |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Status**           | CLOSED 2026-09-23. F1 dan F2 selesai; commit lokal `app-ui` + catatan draft 023 ini, baris register draft 007, amandemen §6.5, dan tiga baris log alasan `DESIGN.md` §11, belum di-push                                              |
