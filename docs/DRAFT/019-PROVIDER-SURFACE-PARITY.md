...
|                        |                                                                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Status**             | DURING berjalan. F1, F2, dan F4 (kecuali baris Check) diperbaiki; F3 dan F5 dibangun ulang setelah owner menolak konsepnya; F6 (label kolom tersembunyi yang melebarkan dokumen di 390 px) ditemukan dan ditutup oleh pengukuran gerbang; baris Check bergantung `app-serv`; blok Aliases dihapus dari kedua bentuk halaman provider dan mendarat sebagai `603bd57` |
...
`app-ui/README.md` sebagai pass ketiga puluh. Penghapusan ini mendarat sebagai satu commit lokal `603bd57`
(22 berkas, 235 sisipan, 1467 hapusan; scope `app-ui` plus SPEC-UI), tanpa push.
