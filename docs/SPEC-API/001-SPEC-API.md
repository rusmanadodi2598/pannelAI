...
| PATCH  | `/api/v1/proxies/{id}`      | S    | Partial update: omitted fields keep stored values, `{}` is refused, `password` write-only (empty keeps the secret) | P2    |
